...
function loadSaleProducts() {
    fetch("http://localhost:5000/api/products/sale-products")
...
window.addEventListener("load", () => {
    setTimeout(() => {
      ...
      document.body.classList.remove("loading"); // Restore scroll & clicks
    }, 500); // 3-second delay
  });
  
  // Apply loading restrictions when the page starts
